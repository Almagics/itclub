...
class JobAddView extends StatefulWidget {
  ...
  @override
  State<JobAddView> createState() => _JobAddViewState();
}
final JobService _materialService = JobService();
...
class _JobAddViewState extends State<JobAddView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: const Center(child: Text("New Job ", style: TextStyle(
          fontSize: 20,
  ...
  void _saveJob() async{
    ...
    try{
      ...
      var result =    await _store.collection("Job")
          .doc(id)
          .set({
